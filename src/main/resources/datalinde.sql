...
-- =========================================================
-- 1. USUARIO
-- 5 CLIENTE + 5 CONDUCTOR + 5 TECNICO + 5 PROGRAMADOR + 1 ADMIN
...
VALUES
(1, 1, '20123456781', '987654321', 'cliente1@linde.com', 'Hospital San Marcos S.A.C.', 'Av. Universitaria 1001, Lima'),
(2, 2, '20234567892', '987654322', 'cliente2@linde.com', 'Clinica Vida Salud S.A.C.', 'Av. Brasil 1250, Lima'),
(3, 3, '20345678903', '987654323', 'cliente3@linde.com', 'Industrias del Pacifico S.A.', 'Av. Argentina 2200, Lima'),
(4, 4, '20456789014', '987654324', 'cliente4@linde.com', 'Laboratorios Andinos S.A.C.', 'Av. Arequipa 1800, Lima'),
(5, 5, '20567890125', '987654325', 'cliente5@linde.com', 'Metalurgica Nacional S.A.', 'Av. Nestor Gambetta 1500, Callao');
...
(id_trabajador, fecha_ingreso, id_usuario, dni, estado, telefono, apellidos, nombres, direccion)
VALUES
(1,  '2023-01-15', 6,  '70123456', 'ACTIVO', '999111111', 'Perez Gomez',      'Carlos',   'Av. Central 101, Lima'),
(2,  '2023-03-20', 7,  '70234567', 'ACTIVO', '999111112', 'Ramirez Torres',   'Luis',     'Av. Norte 202, Lima'),
(3,  '2022-06-10', 8,  '70345678', 'ACTIVO', '999111113', 'Flores Diaz',      'Miguel',   'Av. Sur 303, Lima'),
(4,  '2024-01-08', 9,  '70456789', 'ACTIVO', '999111114', 'Castillo Ruiz',    'Jose',     'Av. Los Olivos 404, Lima'),
(5,  '2024-04-18', 10, '70567890', 'ACTIVO', '999111115', 'Quispe Soto',      'Jorge',    'Av. Peru 505, Lima'),

(6,  '2022-02-14', 11, '70678901', 'ACTIVO', '999222221', 'Huaman Perez',     'Andrea',   'Av. Industrial 606, Lima'),
(7,  '2023-05-11', 12, '70789012', 'ACTIVO', '999222222', 'Mendoza Rojas',    'Patricia', 'Av. Lima 707, Lima'),
(8,  '2024-02-19', 13, '70890123', 'ACTIVO', '999222223', 'Vargas Leon',      'Daniel',   'Av. Colonial 808, Callao'),
(9,  '2023-08-22', 14, '70901234', 'ACTIVO', '999222224', 'Salazar Cruz',     'Fernando', 'Av. Grau 909, Lima'),
(10, '2024-06-17', 15, '71012345', 'ACTIVO', '999222225', 'Chavez Molina',    'Ricardo',  'Av. Tacna 1000, Lima'),

(11, '2022-01-10', 16, '71123456', 'ACTIVO', '999333331', 'Torres Silva',     'Alejandro','Av. Primavera 110, Lima'),
(12, '2022-09-05', 17, '71234567', 'ACTIVO', '999333332', 'Garcia Paredes',   'Diego',    'Av. San Luis 220, Lima'),
(13, '2023-07-03', 18, '71345678', 'ACTIVO', '999333333', 'Morales Vega',     'Christian','Av. Canada 330, Lima'),
(14, '2024-03-12', 19, '71456789', 'ACTIVO', '999333334', 'Ramos Herrera',    'Sergio',   'Av. Javier Prado 440, Lima'),
(15, '2024-05-25', 20, '71567890', 'ACTIVO', '999333335', 'Espinoza Castro',  'Martin',   'Av. Angamos 550, Lima');
...
(id_trabajador, categoria_licencia, licencia_conducir, fecha_vencimiento_licencia)
VALUES
...
VALUES
(6,  'Senior', 'Certificacion Mantenimiento 01', 'Mecanica de cisternas'),
(7,  'Junior', 'Certificacion Mantenimiento 02', 'Sistemas hidraulicos'),
(8,  'Senior', 'Certificacion Mantenimiento 03', 'Sistemas electricos'),
(9,  'Senior', 'Certificacion Mantenimiento 04', 'Mantenimiento industrial'),
(10, 'Junior', 'Certificacion Mantenimiento 05', 'Diagnostico de vehiculos');
...
(id_producto, precio_unitario, estado, unidad_medida, tipo_gas, nombre)
VALUES
(1, 150.00, 'ACTIVO', 'm3', 'OXIGENO', 'Oxigeno Medicinal'),
(2, 180.00, 'ACTIVO', 'm3', 'OXIGENO', 'Oxigeno Industrial'),
(3, 95.00,  'ACTIVO', 'm3', 'NITROGENO', 'Nitrogeno Industrial'),
(4, 110.00, 'ACTIVO', 'm3', 'ARGON', 'Argon Industrial'),
(5, 130.00, 'ACTIVO', 'm3', 'CO2', 'Dioxido de Carbono');
...
INSERT INTO pedido
(id_pedido, fecha_entrega_estimada, fecha_registro, id_cliente, prioridad, estado)
VALUES
(1, '2026-09-22', '2026-09-18', 1, 'ALTA',   'RECIBIDO'),
(2, '2026-09-23', '2026-09-18', 2, 'MEDIA',  'EN PREPARACION'),
...
VALUES
(1, 1, '2026-09-18 08:30:00', 'RECIBIDO',      'Pedido registrado correctamente.'),
(2, 2, '2026-09-18 10:15:00', 'EN PREPARACION','Pedido enviado al area de preparacion.'),
(3, 3, '2026-09-19 11:20:00', 'DESPACHADO',    'Pedido entregado al area de distribucion.'),
(4, 4, '2026-09-20 13:45:00', 'ENTREGADO',     'Entrega completada satisfactoriamente.'),
(5, 5, '2026-09-20 15:10:00', 'RECIBIDO',      'Pedido recibido y pendiente de programacion.');
...
(id_atencion, id_cisterna, id_conductor, id_pedido, id_programador,
 fecha_fin, fecha_fin_programada, fecha_inicio, fecha_inicio_programada,
...
VALUES
(1, 1, '2026-09-22 11:30:00', 'ACTIVA',   'DEMORA',        'La atencion presenta una demora de 30 minutos.'),
(2, 2, '2026-09-23 15:00:00', 'ACTIVA',   'PENDIENTE',     'La atencion aun no ha iniciado.'),
(3, 3, '2026-09-24 12:00:00', 'ATENDIDA', 'RETRASO',       'Se detecto retraso en la entrega.'),
(4, 4, '2026-09-20 16:30:00', 'CERRADA',  'SEGUIMIENTO',   'Entrega proxima a finalizar.'),
(5, 5, '2026-09-26 14:30:00', 'ACTIVA',   'PROGRAMACION',  'La atencion se encuentra proxima a su horario.');
...
VALUES
(1, 1, 1, '2026-09-10 09:20:00', 'REPORTADA',  'Fuga detectada en una valvula de presion.'),
(2, 2, 2, '2026-09-11 14:10:00', 'EN REVISION','Falla en el sistema hidraulico.'),
(3, 3, 3, '2026-09-12 08:45:00', 'REPARADA',   'Problema en el sistema electrico.'),
(4, 4, 4, '2026-09-13 16:30:00', 'REPORTADA',  'Desgaste de frenos detectado.'),
(5, 5, 5, '2026-09-14 10:15:00', 'EN REVISION','Anomalia en el sistema de bombeo.');
...
(5, 5, 5, 10, '2026-09-15 11:45:00',
 510.00,
 'Revision del sistema de bombeo.',
...
INSERT INTO factura
(id_factura, fecha_emision, id_pedido, moneda, tipo_comprobante, numero)
VALUES
...
(id_guia, fecha_emision, fecha_inicio_traslado, id_pedido, numero,
 motivo_traslado, punto_llegada, punto_partida)
VALUES
...
INSERT INTO token
(id, user_id, date_creation, date_expiration, access_type, token, type)
VALUES
